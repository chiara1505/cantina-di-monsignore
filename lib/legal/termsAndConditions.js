...
export const TERMS_AND_CONDITIONS_SECTIONS = [
  {
    ...
    list: [
      ...
      `Il punto vendita e la cantina si trovano in Piazza Sant'Antonio n. 5, Castiglione di Sicilia (CT), come indicato nella pagina Contatti del sito.`,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `In assenza di specifico accordo, il cliente può concordare il ritiro presso il ristorante in Piazza Sant'Antonio n. 5, Castiglione di Sicilia (CT), negli orari di apertura indicati sul sito.`,
