    ...
    return (
        <>
            ...
            <div className="items-container row clearfix">
                ...
                <div className="inner-box">
                  ...
                  <div className="content-box">
                    <div className="view-btn">
                      <Link href="assets/images/gallery/gallery-13.jpg" className="lightbox-image" data-fancybox="gallery">
                    ...
                    <div className="text">
                      <p>Tourist Guide</p>
                      <h3>
                        <Link href="index-3">Main Tourist Spots</Link>
                      </h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="gallery-block-two">
                                <div className="inner-box">
                                    <figure className="image-box"><img src="assets/images/gallery/gallery-14.jpg" alt="" /></figure>
                                    <div className="content-box">
                                        <div className="view-btn"><Link href="assets/images/gallery/gallery-14.jpg" className="lightbox-image" data-fancybox="gallery">
                ...
                <div className="gallery-block-two">
                                <div className="inner-box">
                                    <figure className="image-box"><img src="assets/images/gallery/gallery-15.jpg" alt="" /></figure>
                                    <div className="content-box">
                                        <div className="view-btn"><Link href="assets/images/gallery/gallery-15.jpg" className="lightbox-image" data-fancybox="gallery">
                                            <i className="icon-16"></i></Link></div>
                                        <div className="text">
                                            <p>Tourist Guide</p>
                                            <h3><Link href="index-3">Main Tourist Spots</Link></h3>
                ...
                <div className="gallery-block-two">
                                <div className="inner-box">
                                    <figure className="image-box"><img src="assets/images/gallery/gallery-16.jpg" alt="" /></figure>
                                    <div className="content-box">
                                        <div className="view-btn"><Link href="assets/images/gallery/gallery-16.jpg" className="lightbox-image" data-fancybox="gallery">
                                            <i className="icon-16"></i></Link></div>
                                        <div className="text">
                                            <p>Tourist Guide</p>
                                            <h3><Link href="index-3">Main Tourist Spots</Link></h3>
                ...
                <div className="gallery-block-two">
                                <div className="inner-box">
                                    <figure className="image-box"><img src="assets/images/gallery/gallery-17.jpg" alt="" /></figure>
                                    <div className="content-box">
                                        <div className="view-btn"><Link href="assets/images/gallery/gallery-17.jpg" className="lightbox-image" data-fancybox="gallery">
                                            <i className="icon-16"></i></Link></div>
                                        <div className="text">
                                            <p>Tourist Guide</p>
                                            <h3><Link href="index-3">Main Tourist Spots</Link></h3>
                ...
                <div className="gallery-block-two">
                                <div className="inner-box">
                                    <figure className="image-box"><img src="assets/images/gallery/gallery-18.jpg" alt="" /></figure>
                                    <div className="content-box">
                                        <div className="view-btn"><Link href="assets/images/gallery/gallery-18.jpg" className="lightbox-image" data-fancybox="gallery"> 
                                        <i className="icon-16"></i></Link></div>
                                        <div className="text">
                                            <p>Tourist Guide</p>
                                            <h3><Link href="index-3">Main Tourist Spots</Link></h3>
