...
export default function Shop() {
  return (
    <section className="shop-section" id="shop">
            <div className="bg-layer parallax-bg" data-parallax='{"y": 100}' style={{ backgroundImage: "url(assets/images/background/shop-bg.jpg)" }}></div>
            <div className="auto-container">
                <div className="sec-title mb_50">
                    <span className="sub-title">Our Shop</span>
                    <h2>Our All Delicious & Tasty <br />Product</h2>
                </div> <Swiper {...swiperOptions} className="four-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">                    
