...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Checkout" breadcrumbImage={PAGE_TITLE_IMAGES.checkout}>
                <div>
                    {/* chechkout */}
                    ...
                    <div className="container">
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 upper-column">
                            ...
                            <div className="coupon single-box">
                                Have a Coupon?{' '}
                                <Link href="checkbox">Click here to enter your code</Link>
                            </div>
                            </div>
                        </div>
                        </div>
                                ...
                                <li className="title clearfix">
                                        ...
                                        <li>
                                            <div className="single-box clearfix">
                                                <img src="assets/images/shop/order-1.jpg" alt="" />
                                        ...
                                        <li>
                                            <div className="single-box clearfix">
                                                <img src="assets/images/shop/order-2.jpg" alt="" />
                                        ...
                                        <li>
                                            <div className="single-box clearfix">
                                                <img src="assets/images/shop/order-3.jpg" alt="" />
                                ...
                                <div className="option-block">
                                        <div className="custom-controls-stacked">
                                            <label className="custom-control material-checkbox">
                                                <input type="checkbox" className="material-control-input" />
                                                <span className="material-control-indicator"></span>
                                                <span className="description">Paypal<Link href="checkout">What is paypal?</Link></span>
                                            </label>
                                        </div>
                                    </div>
