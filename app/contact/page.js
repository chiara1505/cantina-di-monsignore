...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Contuct Us" breadcrumbImage={PAGE_TITLE_IMAGES.contact}>
                <div>
                     {/* Contact Form Section */}
                     <section className="contact-section bg-color-panna">
